...
module gApp {
    ...
    c1.setOrientation(Controls.TParamOrientation.EHorizontal);
    c1.setData(data);
    ...
    c2.setOrientation(Controls.TParamOrientation.EHorizontal);
    c2.setData(data);
...
//c2.setAnimationInterval(0.2);
    ...
    c3.setOrientation(Controls.TParamOrientation.EHorizontal);
    c3.setData(data);
