...
(function (Controls) {
    ...
    var CMetaDataDisplayUtil = (function () {
        function CMetaDataDisplayUtil(aParentEl, aImageBaseUrl, aDimming) {
            ...
            var imgs = [
                ...
                'icon_kept.png',
                'icon_watched.png',
                'icon_watched_part.png',
                'icon_deleted_soon.png',
                'icon_failed.png',
                'icon_restart.png',
                'icon_ondemand.png',
                'icon_series.png',
        ...
        CMetaDataDisplayUtil.prototype.destroy = function () {
            var i;
            var len = this._imageLoader.items.length;
            for (i = 0; i < len; i += 1) {
    ...
    var CButton = (function (_super) {
        ...
        CButton.prototype._doKeyEnter = function () {
            if (this._handler) {
                this._handler();
            }
        };
